...
//获取service详情
func(s *servicev1) GetServicetDetail(client *kubernetes.Clientset, serviceName, namespace string) (service *corev1.Service, err error) {
...
//更新service
func(s *servicev1) UpdateService(client *kubernetes.Clientset, namespace, content string) (err error) {
